...
console.log(basket);
  ...
  return (
    <nav className="header">
      {/* logo */}
      <Link to="/">
      <img className="header__logo" src="https://www.pngmart.com/files/Amazon-Logo-Download-PNG-Image.png" 
      alt="amazon_logo" />
      </Link>
      ...
      <img className="header__searchIcon" src="https://www.freeiconspng.com/thumbs/search-icon-png/search-icon-png-5.png"
       alt="search"/>
